...
#define LCD_4_Bit_Data_Port DIO_PORTC
#define LCD_4_Bit_Data_Bus PORTC
#define LCD_8_Bit_Data_Port DIO_PORTC

#define LCD_4_Bit_Control_Port DIO_PORTD
#define LCD_8_Bit_Control_Port DIO_PORTD
